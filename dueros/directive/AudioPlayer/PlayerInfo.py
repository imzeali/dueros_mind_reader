...
class PlayerInfo:
    ...
    def set_lyric(self, url):
        ...
        :return:
        """
        if not Utils.check_keys_in_dict(self.data, ['content', 'lyric']):
    ...
    def set_art(self, src):
        ...
        :return:
        """
        if not Utils.check_keys_in_dict(self.data, ['content', 'art']):
    ...
    def set_provider(self, name, logo):
        ...
        :return:
        """
        if not Utils.check_keys_in_dict(self.data, ['content', 'provider']):
            self.data['content']['provider'] = {}

        if name is not None:
            self.data['content']['provider']['name'] = str(name)

        if not Utils.check_keys_in_dict(self.data, ['content', 'provider', 'logo']):
    ...
    def set_controls(self, controls):
        ...
        :return:
        """
        if not Utils.check_key_in_dict(self.data, 'controls'):
            self.data['controls'] = []
