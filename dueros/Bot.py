...
class Bot(Base):
    ...
    def set_private_key(self, private_key):
        ...
        self.botMonitor.set_environment_info(private_key, 1)
        return self
    ...
    def del_session_attribute(self, field):
        """
        删除session某个字段值
        :param field:
        :param value:
    ...
    def run(self, build=True):
        ...
        ret = self.intent_event_handler(ret, event_handler)
