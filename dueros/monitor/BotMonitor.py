...
class BotMonitor:
    ...
    def set_pre_event_start(self):
        pass
    def set_pre_event_end(self):
        pass
    def set_post_event_start(self):
        pass
    def set_post_event_end(self):
        pass
    ...
    def __upload_data(self, data, headers):
        ...
        req = urllib2.Request(self.config.get_upload_url(), data, headers)
