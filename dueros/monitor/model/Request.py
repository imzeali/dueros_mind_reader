...
class Request:
    ...
    def get_device_id(self):
        ...
        if Utils.check_keys_in_dict(self.data,['context','System','device','deviceId']):
    ...
    def get_audio_player_context(self):
        ...
        :return:
        '''
        if Utils.check_keys_in_dict(self.data,['context','AudioPlayer']):
    ...
    def get_app_launcher_context(self):
        ...
        :return:
        '''
        if Utils.check_keys_in_dict(self.data,['context','AppLauncher']):
    ...
    def get_user_info(self):
        ...
        :return:
        '''
        if Utils.check_keys_in_dict(self.data, ['user_info']):
    ...
    def get_user_id(self):
        ...
        if Utils.check_keys_in_dict(self.data, ['context', 'System', 'user', 'userId']):
    ...
    def get_location(self):
        if Utils.check_keys_in_dict(self.data, ['context','System','user', 'userInfo','location','geo']):
            return self.data['context']['System']['user']['userInfo']['location']['geo']
        return None

    def get_timestamp(self):

        if Utils.check_keys_in_dict(self.data, ['request','timestamp']):
    ...
    def get_botid(self):
        if Utils.check_keys_in_dict(self.data,['context','System','application','applicationId']):
            return self.data['context']['System']['application']['applicationId']
        return None

    def get_request_id(self):

        if Utils.check_keys_in_dict(self.data,['request','requestId']):
    ...
    def get_reson(self):
        ...
        if Utils.check_keys_in_dict(self.data, ['request','reason']):
    ...
    def get_session_id(self):
        ...
        if Utils.check_keys_in_dict(self.data,['session', 'sessionId']):
